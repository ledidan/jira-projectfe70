...
export default function HeaderComponent() {
  ...
  return (
    <nav className="bg-dark border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-800">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex items-center md:order-2">
          ...
          {/* Dropdown menu */}
          <div
            className="hidden z-50 my-4 text-base list-none bg-dark rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
            id="dropdown"
          >
